...
<div class="col-xl-9 col-lg-8 col-md-12">
	...
	<div class="row">
		<div class="col-xl-12 col-lg-12 col-md-12">
			...
			<div class="row">
			<input type="hidden" class="form-control" name="emp_id" id="emp_id" value="{{Auth::user()->id}}">
									...
									<tr>
										...
										<!-- <td>
																	<a href="javascript::void(0)" class="avatar">																	
																		<img alt="avatar image" src="{{url('public/profile/'.$value->employee->profile_image)}}" class="img-fluid">
																	    <div></div>
																	</a>
