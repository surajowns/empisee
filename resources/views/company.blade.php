...
<div class="col-xl-9 col-lg-8 col-md-12">
    <div class="card shadow-sm grow ctm-border-radius">
        <div class="card-body align-center">
            <h4 class="card-title float-left mb-0 mt-2">{{count($company)}} Company</h4>
            ...
            <div class="card ctm-border-radius shadow-sm grow flex-fill">
                <div class="card-header">
                    <h4 class="card-title mb-0">
                        ...
                        @if($permission)
                        @foreach($permission as $permisionvalue)
                        @if($permisionvalue['sidebar_id']==7)
                        <button class="float-right btn btn-theme text-white ctm-border-radius button-1" data-toggle="modal" data-target="#update-information{{$value->id}}"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button>
                        @endif
                        @if($permisionvalue['sidebar_id']==8)
                        <button class="float-right btn btn-theme text-white ctm-border-radius button-1  delete-company" data-delete_company="{{$value->id}}"><i class="fa fa-trash-o" aria-hidden="true"></i></button>
                        @endif
                        @endforeach
                        @endif
                    </h4>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            <p><span class="text-primary font-weight-bold">Register Number : </span>{{$value->reg_comp_no}}</p>
                            <p><span class="text-primary font-weight-bold">Incorporation Date : </span>{{$value->incorporat_date}}</p>
                            <p><span class="text-primary font-weight-bold">VAT Number : </span>{{$value->vat_number}}</p>
                        </div>
                        <div class="col-md-6">
                            <p>
            ...
            <div class="card ctm-border-radius shadow-sm grow flex-fill">
                ...
                <div class="card-body">
                    <div class="input-group mb-3">
                        <input type="text" class="form-control" placeholder="Contact" value="{{$value->contact_no}}" disabled>

                    </div>
                    <div class="input-group mb-3">
                        <input type="text" class="form-control" placeholder="Website Link" value="{{$value->company_url}}" disabled>

                    </div>
                    <div class="input-group mb-0">
                        <input type="email" class="form-control" placeholder="Mail Id" value="{{$value->email}}" disabled>
            ...
            <div class="card ctm-border-radius shadow-sm grow flex-fill">
                ...
                <div class="card-body">
                    ...
                    <div class="text-center mt-3">
                        ...
                        @foreach($permission as $permisionvalue)
                        @if($permisionvalue['sidebar_id']==7)
                        <button class="btn btn-theme text-white ctm-border-radius button-1" data-toggle="modal" data-target="#update-address{{$value->id}}">Update Address</button>
                        @endif
                        @endforeach
                        @endif
                    </div>
...
@foreach($company as $value)
<div class="modal fade" id="update-information{{$value->id}}" role="document">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <!-- Modal body -->
            <div class="modal-body style-add-modal">
                ...
                <form method="POST" id="update_form{{$value->id}}">
                    <input type="hidden" name="id" value="{{$value->id}}">
                    <div class="form-group">
                        <div class="input-group mb-3">
                            <input class="form-control" type="text" name="company_name" value="{{$value->company_name}}" placeholder="Company Name" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="input-group mb-3">
                            <input class="form-control" type="text" name="reg_comp_no" value="{{$value->reg_comp_no}}" placeholder="Registered Company Number">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="input-group mb-3">
                            <input class="form-control datetimepicker" type="text" name="incorporat_date" value="{{$value->incorporat_date}}" placeholder="Incorporation Date">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="input-group mb-3">
                            <input class="form-control" type="text" name="vat_number" value="{{$value->vat_number}}" placeholder="Vat Number">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="input-group mb-3">
                            <input class="form-control" type="number" name="contact_no" value="{{$value->contact_no}}" placeholder="Contact Number">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="input-group mb-3">
                            <input class="form-control" type="email" name="email" value="{{$value->email}}" placeholder="Email Address">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="input-group mb-3">
                            <input class="form-control" type="text" name="company_url" value="{{$value->company_url}}" placeholder="Company Url">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="input-group mb-3">
                            <input class="form-control" type="text" name="city" value="{{$value->city}}" placeholder="City">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="input-group mb-3">
                            <input class="form-control" type="text" name="country" value="{{$value->country}}" placeholder="Country">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="input-group mb-3">
                            <input class="form-control" type="text" name="pin_code" value="{{$value->pin_code}}" placeholder="Post-Code">
                        </div>
                    </div>
                    <button type="button" class="btn btn-danger text-white ctm-border-radius float-right ml-3" data-dismiss="modal">Cancel</button>
                    <button type="button" type="submit" class="btn btn-theme ctm-border-radius text-white float-right button-1 update_company" data-company_id="{{$value->id}}">Update</button>
                </form>
            </div>
        </div>
    </div>
...
@endforeach
@foreach($company as $value)
<div class="modal fade" id="update-address{{$value->id}}" role="update address">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <!-- Modal body -->
            <div class="modal-body style-add-modal">
                ...
                <form method="POST" id="address_form{{$value->id}}">
                    <input type="hidden" name="id" value="{{$value->id}}">
                    <div class="form-group">
                        <div class="input-group mb-3">
                            <input class="form-control" type="text" name="register_address" value="{{$value->register_address}}" placeholder="Register Office Address">
                        </div>
                        <div class="input-group mb-3">
                            <input class="form-control" type="text" name="corporat_address" value="{{$value->corporat_address}}" placeholder="Corporate Office Address">
                        </div>
                    </div>
                    <button type="button" class="btn btn-danger text-white ctm-border-radius float-right ml-3" data-dismiss="modal">Cancel</button>
                    <button type="button" class="btn btn-theme ctm-border-radius text-white float-right button-1 update_add" data-address_id="{{$value->id}}">Add</button>
                </form>
