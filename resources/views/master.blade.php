...
<head>
	...
	<!-- Linearicon Font -->
	<link rel="stylesheet" href="{{url('public/assets/css/lnr-icon.css')}}">

	<!-- Fontawesome CSS -->
	<link rel="stylesheet" href="{{url('public/assets/css/font-awesome.min.css')}}">

	<!-- Select2 CSS -->
	<link rel="stylesheet" href="{{url('public/assets/plugins/select2/select2.min.css')}}">
	...
	<link rel="stylesheet" href="{{url('public/assets/css/font-awesome.min.css')}}">
	<!-- Tagsinput CSS -->
	<link rel="stylesheet" href="{{url('public/assets/plugins/bootstrap-tagsinput/bootstrap-tagsinput.css')}}">
	<!-- Custom CSS -->
...
<body>
				...
				<div class="row">
					<div class="col-xl-3 col-lg-4 col-md-12 theiaStickySidebar">
						<aside class="sidebar sidebar-user">
													...
													<div class="custom-search input-group">
														<div class="custom-breadcrumb">
															<ol class="breadcrumb no-bg-color d-inline-block p-0 m-0 mb-2">
																<li class="breadcrumb-item d-inline-block"><a href="{{Session::get('logRole')==1?url('/dashboard'):url('/emp_dashboard')}}" class="text-dark">Home</a></li>
							...
							@if(Request::segment(1)=='dashboard' || Request::segment(1)=='emp_dashboard')
							<div class="user-card card shadow-sm bg-white text-center ctm-border-radius grow">
								<div class="user-info card-body">
									<div class="user-avatar mb-4">
										@if(Auth::user()->profile_image)
										<img src="{{url('public/profile/'.Auth::user()->profile_image)}}" alt="User Avatar" class="img-fluid rounded-circle" width="100">
										@else
										<img class="img-fluid rounded-circle " src="{{url('public/assets/img/profiles/1613731537.png')}}" alt="{{Auth::user()->name}}" width="100">
	...
	<script src="{{url('public/assets/plugins/select2/moment.min.js')}}"></script>

	<script src="{{url('public/assets/js/bootstrap-datetimepicker.min.js')}}"></script>
	<script src="{{url('public/assets/plugins/bootstrap-tagsinput/bootstrap-tagsinput.min.js')}}"></script>
	...
	<!-- Sticky sidebar JS -->
	<script src="{{url('public/assets/plugins/theia-sticky-sidebar/ResizeSensor.js')}}"></script>
	<script src="{{url('public/assets/plugins/theia-sticky-sidebar/theia-sticky-sidebar.js')}}"></script>
	<!-- Custom Js -->
	<script src="{{url('public/assets/js/script.js')}}"></script>
	<!--calender -->
	<script src="{{url('public/assets/js/jquery-ui.min.js')}}"></script>

	<script src="{{url('public/assets/plugins/fullcalendar/fullcalendar.min.js')}}"></script>
	<script src="{{url('public/assets/plugins/fullcalendar/jquery.fullcalendar.js')}}"></script>
	...
	<script>
		$(document).ready(function() {
			if ('serviceWorker' in navigator) {
				navigator.serviceWorker.register('{{url("public/firebase-messaging-sw.js")}}')
