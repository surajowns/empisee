                ...
                <tr>
                    <td bgcolor="#fff">
                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tr>
                                <td align="center"><a href="{{url('/')}}" target="_blank"> <img src="https://localhost/empisee/public/assets/img/logo.png" style="display: block; border: 0px;" /></a> </td>
                            </tr>
                        </table>
                    </td>
                </tr>
                        ...
                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                            ...
                            <tr>
                                <td style="padding: 0px 40px 20px 40px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #555555; text-align: left; font-weight:bold;">
                                    ...
                                    <p><a href="mailto:care@shoppershawk.com;">hr@besthawk.com</a></p>
