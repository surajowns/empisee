<?php $__env->startSection('title','Employee Leave Details'); ?>
...
<div class="col-xl-9 col-lg-8  col-md-12">
						...
						<table class="table custom-table table-hover ">
							...
							<tbody id="table_data">
								...
								<tr>
                                    ...
                                    <td><?php echo e($value->casual_leave); ?></td>
									<td><?php echo e($value->sick_leave); ?></td>
									
									<td><?php echo e($value->cl_taken); ?></td>
									<td><?php echo e($value->ml_taken); ?></td>
                                    <!-- <td><?php echo e($value->total_leave); ?></td> -->
									<!-- <td><?php echo e($value->cl_taken + $value->ml_taken); ?></td> -->
									<td>
										...
										<a href="javascript:void(0);" class="btn btn-sm btn-outline-danger delete-leave" data-id="<?php echo e($value->id); ?>">
	...
	<script>
		$(document).ready(function() {
			...
			$(document).on('click', '#assing_leave', function(e) {
				...
				$.ajax({
					Type: "GET",
					url: '<?php echo e(url("assign_leave")); ?>',
					dataType: 'json',
					cache: false,
			...
			$(document).on('click', '.update_assets', function(e) {
				...
				$.ajax({
					Type: "GET",
					url: '<?php echo e(url("update_leave")); ?>',
					dataType: 'json',
					cache: false,
			...
			$(document).on('click', '.edit_assets', function(e) {
				...
				$.ajax({
					Type: "GET",
					url: '<?php echo e(url("update_modal_leave")); ?>',
					dataType: 'json',
					cache: false,
					data: {
						id: id
			...
			$(document).on('click', '.delete-leave', function(e) {
				...
				if (confirm("Do You Want to Remove The Assets")) {
					...
					$.ajax({
						Type: "GET",
						url: '<?php echo e(url("delete_leaves")); ?>',
						dataType: 'json',
						cache: false,
						data: {
							assets_id: assets_id
	...
	<?php $__env->stopSection(); ?>
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\empisee\resources\views/employee_leave_details.blade.php ENDPATH**/ ?>