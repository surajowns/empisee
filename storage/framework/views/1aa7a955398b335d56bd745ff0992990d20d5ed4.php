        ...
        <section class="user-dashbord" style="margin-top:200px;">
         ...
         <div id="invoice" class="">
            ...
            <table class="table table-bordered">
                     ...
                     <tr class="list-item">
                        <th colspan="4" class="tableitem text-center"> Pay Slip of <?php echo e(date('F Y',strtotime($emp_payments->month))); ?> </th>
                     </tr>
                     <tr class="list-item">
                        <th class="tableitem text-left">Employee Name : </th>
                        <td><?php echo e($emp_payments->employee->name); ?></td>
                        <th> Employee Code :</th>
                        <td><?php echo e($emp_payments->employee->emp_code); ?></td>
                     </tr>
                     <tr class="list-item">
                        <th class="tableitem">Designation :</th>
                        <td><?php echo e($emp_payments->employee->emp_details[0]['job_title']); ?></td>
                        <th> Department</th>
                     ...
                     <tr class="list-item">
                        ...
                        <td>Noida</td>
                        <th> PF Number :</th>
                        <td><?php echo e($emp_bank_details['pf_or_uan_no']); ?></td>
                     </tr>
                     <tr class="list-item">
                        <th class="tableitem">Date of Joining: </th>
                        <td><?php echo e($emp_payments->employee->emp_details[0]['joining_date']); ?></td>
                        <th> ESIC Number :</th>
                        <td><?php echo e($emp_bank_details['esic_no']); ?></td>
                     </tr>
                     <tr class="list-item">
                        <th class="tableitem">Paid Days : </th>
                        <td>26</td>
                        <th> Bank A/C No. :</th>
                        <td><?php echo e($emp_bank_details['bank_account_no']); ?></td>
                     </tr>
                     <tr class="list-item">
                     ...
                     <tr class="list-item">
                        ...
                        <td><?php echo e(number_format($salry_details['basic_salary'],2)); ?></td>
                        <th>TDS:</th>
                        <td><?php echo e(number_format($salry_details['tds'],2)); ?></td>
                     </tr>
                     <tr class="list-item">
                        <th class="tableitem">House Rent Allowance : </th>
                        <td><?php echo e(number_format($salry_details['hra'],2)); ?></td>
                        <th>PF:</th>
                        <td><?php echo e(number_format($salry_details['pf'],2)); ?></td>
                     </tr>
                     <tr class="list-item">
                        <th class="tableitem">Medical Allowance : </th>
                        <td><?php echo e(number_format($salry_details['medical_allowance'],2)); ?></td>
                        <th>ESIC :</th>
                        <td><?php echo e(number_format($salry_details['esic'],2)); ?></td>
                     </tr>
                     <tr class="list-item">
                        <th class="tableitem">Conveyance: </th>
                        <td><?php echo e(number_format($salry_details['conveyance'],2)); ?></td>
                        <th>Leave without pay:</th>
                        <td><?php echo e($emp_payments['leave_without_pay']); ?></td>
                     </tr>
                     <tr class="list-item">
                        <th class="tableitem">Other Allowance : </th>
                        <td><?php echo e(number_format($salry_details['mix_allowance'],2)); ?></td>
                        <th>Loan Deduction :</th>
                        <td><?php echo e(number_format($emp_payments['loan'],2)); ?></td>
                     </tr>
                     <tr class="list-item">
                        <th class="tableitem">Bonus If Any: </th>
                        <td><?php echo e(number_format($emp_payments['bonus'],2)); ?></td>
                        <th>Other Deduction :</th>
                        <td><?php echo e(number_format($emp_payments['other_deduction'],2)); ?></td>
                     </tr>
                  </table>
                  <table class="table table-bordered">
                     <tr class="list-item">
                        <th class="tableitem">Gross Salary :</th>
                        <td><?php echo e(number_format($salry_details['emp_salary'],2)); ?></td>
                        <th> Total Deduction: </th>
                        <td><?php echo e($total_detuction); ?></td>
                     </tr>
                     <tr class="list-item">
                        <th class="tableitem">Net Payable: </th>
                        <td colspan="3"><?php echo e(number_format($emp_payments['net_pay'],2)); ?></td>
                     </tr>
                     <tr class="list-item">
...
</html><?php /**PATH C:\xampp\htdocs\empisee\resources\views/salary_slip.blade.php ENDPATH**/ ?>