...
<div class="col-xl-9 col-lg-8  col-md-12">
	<div class="card shadow-sm ctm-border-radius grow">
		<div class="card-header d-flex align-items-center justify-content-between">
			...
			<div class="card-header d-flex align-items-center justify-content-between">
		<form class="input-group" action="<?php echo e(url('bank_details_report')); ?>" method="get" >
						...
						<table class="table custom-table table-hover ">
							...
							<tbody id="table_data">
								...
								<tr>
									...
									<td><?php echo e($value->account_full_name); ?></td>
									<td><?php echo e($value->bank_account_no); ?></td>
									<td><?php echo e($value->bank_name); ?></td>
									<td><?php echo e($value->ifsc_code); ?></td>
									<td><?php echo e($value->branch_name); ?></td>
									<td><?php echo e($value->address); ?></td>
									<td><?php echo e($value->pan_card_no); ?></td>
									<td><?php echo e($value->pf_or_uan_no); ?></td>
									<td><?php echo e($value->esic_no); ?></td>
									<td>
	...
	<script>
		$(document).ready(function() {
			...
			$(document).on('click', '#assing_assets', function(e) {
				...
				$.ajax({
					Type: "GET",
					url: '<?php echo e(url("add_bank_account")); ?>',
					dataType: 'json',
					cache: false,
			...
			$(document).on('click', '.update_assets', function(e) {
				...
				$.ajax({
					Type: "GET",
					url: '<?php echo e(url("update_bank_account")); ?>',
					dataType: 'json',
					cache: false,
			...
			$(document).on('click', '.edit_assets', function(e) {
				...
				$.ajax({
					Type: "GET",
					url: '<?php echo e(url("updatemodal_bank_account")); ?>',
					dataType: 'json',
					cache: false,
					data: {
						id: id
	...
	<?php $__env->stopSection(); ?>
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\empisee\resources\views/bank_account.blade.php ENDPATH**/ ?>