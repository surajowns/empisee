        ...
        <div class="col-md-12">
            <div class="<?php echo e(!in_array($emp_id,json_decode($val->seen_by))?'card':''); ?> ctm-border-radius shadow-sm grow flex-fill">
                <div class="card-body">
                    ...
                    <span class="text-danger" style="font-size:10px;"> <?php echo e(date('d/m/y',strtotime($val->created_at))); ?>(<?php echo e(date('l',strtotime($val->created_at))); ?>) - <?php echo e(date('h:s A',strtotime($val->created_at))); ?></span>
                </div>
            </div>
        </div>
